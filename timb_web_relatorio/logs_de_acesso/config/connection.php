...
class connect_mysql{
  ...
  //METODO CONSTRUTOR -- 
  //NAO INVOCO NADA NESTA FUNวรO POIS AINDA NรO RECEBI A VARIAVEL PARAMENTRO DO ARQUIVO QUE POSSUI O GRAFICO
  function connect_mysql(){

  }
  
  //ESTA FUNวรO AO SER CHAMADA PELOS ARQUIVOS DE GRAFICO - Jม DECLARAM A VARIAVEL paramentro PARA CADA TIPO DE GRAFICO
  ...
  function prepara_conection(){    
    ...
    //PARA REALIZAR A CONEXรO RECEBE COMO PARAMETRO A CONEXรO
   ...
   * @param  [type] $mysqli      Conexใo do banco      
   * @param  [boolean] $flag     Para trazer o resultado em MYSQL_ASSOC ou nใo
